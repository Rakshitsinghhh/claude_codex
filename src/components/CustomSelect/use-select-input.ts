...
export const useSelectInput = <T>({
  ...
  // Register Select as an active keybinding context (same pattern as ThemePicker).
  // Without this, chord resolution in chordInterceptor can miss Select-scoped
  // bindings in some trees, so arrow keys / Enter never reach the list handlers.
